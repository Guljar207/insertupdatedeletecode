...
if (isset($_POST['submit'])) {
  ...
  $sql = "INSERT INTO stdinfo (firstname, lastname, emailid, mobilenumber, address, city, pincode, state, gender, hobbies,image_path) VALUES ('$fn', '$ln', '$ei', '$mn', '$add', '$ct', '$pc', '$st', '$gen', '$hobbies','$target')";
...
if (mysqli_num_rows($result) > 0) {
  ...
  echo "<tr><th>ID</th><th>First Name</th><th>Last Name</th><th>Email ID</th><th>Mobile Number</th><th>Address</th><th>City</th><th>Pin Code</th><th>State</th><th>Gender</th><th>Hobbies</th><th>Profile Image</th><th>Action</th></br>
